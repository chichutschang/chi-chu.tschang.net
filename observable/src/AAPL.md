...
```
```js
const latestPrice = price.slice(-1)[0]; 
// display(latestPrice.Date)
// display((latestPrice.Date).toLocaleString("en-US", 
//         {
//             year: 'numeric', 
//             month: 'long', 
//             day: 'numeric',
        ...
        <tr>
            ...
            <td style="padding-left: 10px">
                <a href="https://hardcover.app/@tschang" target="_blank">
                    <img id="hardcover-icon" alt="Hardcover" style="height: 18px; margin-bottom: 4px; transform: rotate(-12deg);">
                </a>
            </td>
        </tr>
    </table>

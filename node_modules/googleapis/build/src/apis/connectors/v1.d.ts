...
export declare namespace connectors_v1 {
    ...
    export class Resource$Projects$Locations$Connections {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Fetchtoolspecoverride, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchToolspecOverride(params?: Params$Resource$Projects$Locations$Connections$Fetchtoolspecoverride, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchConnectionToolspecOverrideResponse>>;
        fetchToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Fetchtoolspecoverride, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetchToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Fetchtoolspecoverride, options: MethodOptions | BodyResponseCallback<Schema$FetchConnectionToolspecOverrideResponse>, callback: BodyResponseCallback<Schema$FetchConnectionToolspecOverrideResponse>): void;
        fetchToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Fetchtoolspecoverride, callback: BodyResponseCallback<Schema$FetchConnectionToolspecOverrideResponse>): void;
        fetchToolspecOverride(callback: BodyResponseCallback<Schema$FetchConnectionToolspecOverrideResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generateToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Generatetoolspecoverride, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        generateToolspecOverride(params?: Params$Resource$Projects$Locations$Connections$Generatetoolspecoverride, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GenerateConnectionToolspecOverrideResponse>>;
        generateToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Generatetoolspecoverride, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        generateToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Generatetoolspecoverride, options: MethodOptions | BodyResponseCallback<Schema$GenerateConnectionToolspecOverrideResponse>, callback: BodyResponseCallback<Schema$GenerateConnectionToolspecOverrideResponse>): void;
        generateToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Generatetoolspecoverride, callback: BodyResponseCallback<Schema$GenerateConnectionToolspecOverrideResponse>): void;
        generateToolspecOverride(callback: BodyResponseCallback<Schema$GenerateConnectionToolspecOverrideResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        modifyToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Modifytoolspecoverride, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        modifyToolspecOverride(params?: Params$Resource$Projects$Locations$Connections$Modifytoolspecoverride, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ModifyConnectionToolspecOverrideResponse>>;
        modifyToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Modifytoolspecoverride, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        modifyToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Modifytoolspecoverride, options: MethodOptions | BodyResponseCallback<Schema$ModifyConnectionToolspecOverrideResponse>, callback: BodyResponseCallback<Schema$ModifyConnectionToolspecOverrideResponse>): void;
        modifyToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Modifytoolspecoverride, callback: BodyResponseCallback<Schema$ModifyConnectionToolspecOverrideResponse>): void;
        modifyToolspecOverride(callback: BodyResponseCallback<Schema$ModifyConnectionToolspecOverrideResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        removeToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Removetoolspecoverride, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        removeToolspecOverride(params?: Params$Resource$Projects$Locations$Connections$Removetoolspecoverride, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        removeToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Removetoolspecoverride, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        removeToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Removetoolspecoverride, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        removeToolspecOverride(params: Params$Resource$Projects$Locations$Connections$Removetoolspecoverride, callback: BodyResponseCallback<Schema$Empty>): void;

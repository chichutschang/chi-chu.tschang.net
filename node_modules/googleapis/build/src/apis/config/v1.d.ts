...
export declare namespace config_v1 {
    ...
    export interface Schema$ProvisionDeploymentGroupRequest {
         ...
         */
        deploymentSpecs?: {
            [key: string]: Schema$DeploymentSpec;
        } | null;
    }
    /**
    ...
    export interface Schema$TerraformBlueprint {
         ...
         */
        externalValues?: {
            [key: string]: Schema$ExternalValueSource;
        } | null;
        /**
    ...
    export class Resource$Projects$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getAutoMigrationConfig(params: Params$Resource$Projects$Locations$Getautomigrationconfig, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getAutoMigrationConfig(params?: Params$Resource$Projects$Locations$Getautomigrationconfig, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AutoMigrationConfig>>;
        getAutoMigrationConfig(params: Params$Resource$Projects$Locations$Getautomigrationconfig, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getAutoMigrationConfig(params: Params$Resource$Projects$Locations$Getautomigrationconfig, options: MethodOptions | BodyResponseCallback<Schema$AutoMigrationConfig>, callback: BodyResponseCallback<Schema$AutoMigrationConfig>): void;
        getAutoMigrationConfig(params: Params$Resource$Projects$Locations$Getautomigrationconfig, callback: BodyResponseCallback<Schema$AutoMigrationConfig>): void;
        getAutoMigrationConfig(callback: BodyResponseCallback<Schema$AutoMigrationConfig>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateAutoMigrationConfig(params: Params$Resource$Projects$Locations$Updateautomigrationconfig, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        updateAutoMigrationConfig(params?: Params$Resource$Projects$Locations$Updateautomigrationconfig, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        updateAutoMigrationConfig(params: Params$Resource$Projects$Locations$Updateautomigrationconfig, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        updateAutoMigrationConfig(params: Params$Resource$Projects$Locations$Updateautomigrationconfig, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        updateAutoMigrationConfig(params: Params$Resource$Projects$Locations$Updateautomigrationconfig, callback: BodyResponseCallback<Schema$Operation>): void;
        updateAutoMigrationConfig(callback: BodyResponseCallback<Schema$Operation>): void;
    }
    ...
    export class Resource$Projects$Locations$Deploymentgroups {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Deploymentgroups$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Deploymentgroups$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        create(params: Params$Resource$Projects$Locations$Deploymentgroups$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Deploymentgroups$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Projects$Locations$Deploymentgroups$Create, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Deploymentgroups$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Deploymentgroups$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Projects$Locations$Deploymentgroups$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Deploymentgroups$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Projects$Locations$Deploymentgroups$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        deprovision(params: Params$Resource$Projects$Locations$Deploymentgroups$Deprovision, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        deprovision(params?: Params$Resource$Projects$Locations$Deploymentgroups$Deprovision, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        deprovision(params: Params$Resource$Projects$Locations$Deploymentgroups$Deprovision, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        deprovision(params: Params$Resource$Projects$Locations$Deploymentgroups$Deprovision, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        deprovision(params: Params$Resource$Projects$Locations$Deploymentgroups$Deprovision, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Deploymentgroups$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Deploymentgroups$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$DeploymentGroup>>;
        get(params: Params$Resource$Projects$Locations$Deploymentgroups$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Deploymentgroups$Get, options: MethodOptions | BodyResponseCallback<Schema$DeploymentGroup>, callback: BodyResponseCallback<Schema$DeploymentGroup>): void;
        get(params: Params$Resource$Projects$Locations$Deploymentgroups$Get, callback: BodyResponseCallback<Schema$DeploymentGroup>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Deploymentgroups$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Deploymentgroups$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListDeploymentGroupsResponse>>;
        list(params: Params$Resource$Projects$Locations$Deploymentgroups$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Deploymentgroups$List, options: MethodOptions | BodyResponseCallback<Schema$ListDeploymentGroupsResponse>, callback: BodyResponseCallback<Schema$ListDeploymentGroupsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Deploymentgroups$List, callback: BodyResponseCallback<Schema$ListDeploymentGroupsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListDeploymentGroupsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Deploymentgroups$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Deploymentgroups$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        patch(params: Params$Resource$Projects$Locations$Deploymentgroups$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Deploymentgroups$Patch, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(params: Params$Resource$Projects$Locations$Deploymentgroups$Patch, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        provision(params: Params$Resource$Projects$Locations$Deploymentgroups$Provision, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        provision(params?: Params$Resource$Projects$Locations$Deploymentgroups$Provision, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        provision(params: Params$Resource$Projects$Locations$Deploymentgroups$Provision, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        provision(params: Params$Resource$Projects$Locations$Deploymentgroups$Provision, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        provision(params: Params$Resource$Projects$Locations$Deploymentgroups$Provision, callback: BodyResponseCallback<Schema$Operation>): void;
    ...
    export class Resource$Projects$Locations$Deploymentgroups$Revisions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Deploymentgroups$Revisions$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Deploymentgroups$Revisions$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$DeploymentGroupRevision>>;
        get(params: Params$Resource$Projects$Locations$Deploymentgroups$Revisions$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Deploymentgroups$Revisions$Get, options: MethodOptions | BodyResponseCallback<Schema$DeploymentGroupRevision>, callback: BodyResponseCallback<Schema$DeploymentGroupRevision>): void;
        get(params: Params$Resource$Projects$Locations$Deploymentgroups$Revisions$Get, callback: BodyResponseCallback<Schema$DeploymentGroupRevision>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Deploymentgroups$Revisions$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Deploymentgroups$Revisions$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListDeploymentGroupRevisionsResponse>>;
        list(params: Params$Resource$Projects$Locations$Deploymentgroups$Revisions$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Deploymentgroups$Revisions$List, options: MethodOptions | BodyResponseCallback<Schema$ListDeploymentGroupRevisionsResponse>, callback: BodyResponseCallback<Schema$ListDeploymentGroupRevisionsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Deploymentgroups$Revisions$List, callback: BodyResponseCallback<Schema$ListDeploymentGroupRevisionsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListDeploymentGroupRevisionsResponse>): void;
    }

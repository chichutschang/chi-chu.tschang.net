...
export declare namespace safebrowsing_v5 {
    ...
    export class Resource$Urls {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        search(params: Params$Resource$Urls$Search, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        search(params?: Params$Resource$Urls$Search, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleSecuritySafebrowsingV5SearchUrlsResponse>>;
        search(params: Params$Resource$Urls$Search, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        search(params: Params$Resource$Urls$Search, options: MethodOptions | BodyResponseCallback<Schema$GoogleSecuritySafebrowsingV5SearchUrlsResponse>, callback: BodyResponseCallback<Schema$GoogleSecuritySafebrowsingV5SearchUrlsResponse>): void;
        search(params: Params$Resource$Urls$Search, callback: BodyResponseCallback<Schema$GoogleSecuritySafebrowsingV5SearchUrlsResponse>): void;
        search(callback: BodyResponseCallback<Schema$GoogleSecuritySafebrowsingV5SearchUrlsResponse>): void;
    }

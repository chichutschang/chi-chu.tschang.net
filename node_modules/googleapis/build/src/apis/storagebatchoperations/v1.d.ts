...
export declare namespace storagebatchoperations_v1 {
    ...
    export class Resource$Projects$Locations$Jobs$Bucketoperations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Jobs$Bucketoperations$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Jobs$Bucketoperations$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BucketOperation>>;
        get(params: Params$Resource$Projects$Locations$Jobs$Bucketoperations$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Jobs$Bucketoperations$Get, options: MethodOptions | BodyResponseCallback<Schema$BucketOperation>, callback: BodyResponseCallback<Schema$BucketOperation>): void;
        get(params: Params$Resource$Projects$Locations$Jobs$Bucketoperations$Get, callback: BodyResponseCallback<Schema$BucketOperation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Jobs$Bucketoperations$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Jobs$Bucketoperations$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListBucketOperationsResponse>>;
        list(params: Params$Resource$Projects$Locations$Jobs$Bucketoperations$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Jobs$Bucketoperations$List, options: MethodOptions | BodyResponseCallback<Schema$ListBucketOperationsResponse>, callback: BodyResponseCallback<Schema$ListBucketOperationsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Jobs$Bucketoperations$List, callback: BodyResponseCallback<Schema$ListBucketOperationsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListBucketOperationsResponse>): void;
    }

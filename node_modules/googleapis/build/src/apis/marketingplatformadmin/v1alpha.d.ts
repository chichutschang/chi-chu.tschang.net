...
export declare namespace marketingplatformadmin_v1alpha {
    ...
    export class Resource$Organizations {
         ...
         */
        findSalesPartnerManagedClients(params: Params$Resource$Organizations$Findsalespartnermanagedclients, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        findSalesPartnerManagedClients(params?: Params$Resource$Organizations$Findsalespartnermanagedclients, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FindSalesPartnerManagedClientsResponse>>;
        findSalesPartnerManagedClients(params: Params$Resource$Organizations$Findsalespartnermanagedclients, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        findSalesPartnerManagedClients(params: Params$Resource$Organizations$Findsalespartnermanagedclients, options: MethodOptions | BodyResponseCallback<Schema$FindSalesPartnerManagedClientsResponse>, callback: BodyResponseCallback<Schema$FindSalesPartnerManagedClientsResponse>): void;
        findSalesPartnerManagedClients(params: Params$Resource$Organizations$Findsalespartnermanagedclients, callback: BodyResponseCallback<Schema$FindSalesPartnerManagedClientsResponse>): void;
        findSalesPartnerManagedClients(callback: BodyResponseCallback<Schema$FindSalesPartnerManagedClientsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        reportPropertyUsage(params: Params$Resource$Organizations$Reportpropertyusage, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        reportPropertyUsage(params?: Params$Resource$Organizations$Reportpropertyusage, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ReportPropertyUsageResponse>>;
        reportPropertyUsage(params: Params$Resource$Organizations$Reportpropertyusage, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        reportPropertyUsage(params: Params$Resource$Organizations$Reportpropertyusage, options: MethodOptions | BodyResponseCallback<Schema$ReportPropertyUsageResponse>, callback: BodyResponseCallback<Schema$ReportPropertyUsageResponse>): void;
        reportPropertyUsage(params: Params$Resource$Organizations$Reportpropertyusage, callback: BodyResponseCallback<Schema$ReportPropertyUsageResponse>): void;
        reportPropertyUsage(callback: BodyResponseCallback<Schema$ReportPropertyUsageResponse>): void;
    }

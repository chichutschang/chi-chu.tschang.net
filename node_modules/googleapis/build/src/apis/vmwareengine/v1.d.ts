...
export declare namespace vmwareengine_v1 {
     ...
     */
    export interface Schema$MigrateManagementVmsRequest {
        /**
    ...
    export class Resource$Projects$Locations$Privateclouds {
         ...
         *   // Do the magic
         *   const res =
         *     await vmwareengine.projects.locations.privateClouds.migrateManagementVms({
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        migrateManagementVms(params: Params$Resource$Projects$Locations$Privateclouds$Migratemanagementvms, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        migrateManagementVms(params?: Params$Resource$Projects$Locations$Privateclouds$Migratemanagementvms, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        migrateManagementVms(params: Params$Resource$Projects$Locations$Privateclouds$Migratemanagementvms, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        migrateManagementVms(params: Params$Resource$Projects$Locations$Privateclouds$Migratemanagementvms, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        migrateManagementVms(params: Params$Resource$Projects$Locations$Privateclouds$Migratemanagementvms, callback: BodyResponseCallback<Schema$Operation>): void;
        migrateManagementVms(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Privateclouds$Migratemanagementvms extends StandardParameters {
        /**
         * Required. The resource name of the private cloud whose management vms are getting migrated. Resource names are schemeless URIs that follow the conventions in https://cloud.google.com/apis/design/resource_names. For example: `projects/my-project/locations/us-central1-a/privateClouds/my-cloud`
         */
        name?: string;
         ...
         * Request body metadata
         */
        requestBody?: Schema$MigrateManagementVmsRequest;
    }

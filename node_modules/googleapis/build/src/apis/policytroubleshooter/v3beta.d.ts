...
export declare namespace policytroubleshooter_v3beta {
    ...
    export interface Schema$GoogleCloudPolicytroubleshooterIamV3betaAllowBindingExplanation {
         ...
         */
        memberships?: {
            [key: string]: Schema$GoogleCloudPolicytroubleshooterIamV3betaAllowBindingExplanationAnnotatedAllowMembership;
        } | null;
        /**
    ...
    export interface Schema$GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanation {
         ...
         */
        deniedPermissions?: {
            [key: string]: Schema$GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanationAnnotatedPermissionMatching;
        } | null;
        /**
         ...
         */
        deniedPrincipals?: {
            [key: string]: Schema$GoogleCloudPolicytroubleshooterIamV3betaDenyRuleExplanationAnnotatedDenyPrincipalMatching;
        } | null;
        /**
    ...
    export class Resource$Iam {
        ...
        troubleshoot(params?: Params$Resource$Iam$Troubleshoot, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyResponse>>;
        ...
        troubleshoot(params: Params$Resource$Iam$Troubleshoot, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyResponse>, callback: BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyResponse>): void;
        troubleshoot(params: Params$Resource$Iam$Troubleshoot, callback: BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyResponse>): void;
        troubleshoot(callback: BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyResponse>): void;
    }

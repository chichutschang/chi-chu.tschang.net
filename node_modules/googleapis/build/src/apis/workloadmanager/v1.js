...
(function (workloadmanager_v1) {
    ...
    class Resource$Projects$Locations$Discoveredprofiles {
        ...
        constructor(context) {
            this.context = context;
            this.health = new Resource$Projects$Locations$Discoveredprofiles$Health(this.context);
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
    ...
    class Resource$Projects$Locations$Discoveredprofiles$Health {
        context;
        constructor(context) {
            this.context = context;
        }
    ...
    workloadmanager_v1.Resource$Projects$Locations$Discoveredprofiles$Health = Resource$Projects$Locations$Discoveredprofiles$Health;

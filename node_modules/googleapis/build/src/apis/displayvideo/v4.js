...
(function (displayvideo_v4) {
    ...
    class Resource$Advertisers$Adassets {
        ...
        upload(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                ...
                params,
                mediaUrl: (rootUrl +
                    '/upload/v4/advertisers/{+advertiserId}/adAssets:uploadAdAsset').replace(/([^:]\/)\/+/g, '$1'),
                requiredParams: ['advertiserId'],
                pathParams: ['advertiserId'],
                context: this.context,
            };
    ...
    class Resource$Advertisers$Adgroups {
        ...
        bulkEditAssignedTargetingOptions(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v4/advertisers/{+advertiserId}/adGroups:bulkEditAssignedTargetingOptions').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    class Resource$Advertisers$Adgroups$Youtubeassettypes {
        ...
        constructor(context) {
            ...
            this.youtubeAssetAssociations =
                new Resource$Advertisers$Adgroups$Youtubeassettypes$Youtubeassetassociations(this.context);
        }
    }
    ...
    class Resource$Advertisers$Adgroups$Youtubeassettypes$Youtubeassetassociations {
        ...
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/youtubeAssetTypes/{+youtubeAssetType}/youtubeAssetAssociations').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
        ...
        delete(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/youtubeAssetTypes/{+youtubeAssetType}/youtubeAssetAssociations/{+youtubeAssetAssociationId}').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'DELETE',
                    apiVersion: '',
                }, options),
                params,
    ...
    class Resource$Advertisers$Lineitems$Youtubeassettypes {
        ...
        constructor(context) {
            this.context = context;
            this.youtubeAssetAssociations =
                new Resource$Advertisers$Lineitems$Youtubeassettypes$Youtubeassetassociations(this.context);
        }
    }
    ...
    class Resource$Advertisers$Lineitems$Youtubeassettypes$Youtubeassetassociations {
        ...
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/youtubeAssetTypes/{+youtubeAssetType}/youtubeAssetAssociations').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
        ...
        delete(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/youtubeAssetTypes/{+youtubeAssetType}/youtubeAssetAssociations/{+youtubeAssetAssociationId}').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'DELETE',
                    apiVersion: '',
                }, options),
                params,

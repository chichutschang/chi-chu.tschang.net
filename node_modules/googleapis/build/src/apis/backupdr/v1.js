...
(function (backupdr_v1) {
    ...
    backupdr_v1.Resource$Folders = Resource$Folders;
    ...
    backupdr_v1.Resource$Folders$Locations = Resource$Folders$Locations;
        ...
        fetch(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/resourceBackupConfigs:fetch').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    backupdr_v1.Resource$Folders$Locations$Resourcebackupconfigs = Resource$Folders$Locations$Resourcebackupconfigs;
    ...
    backupdr_v1.Resource$Organizations = Resource$Organizations;
    ...
    backupdr_v1.Resource$Organizations$Locations = Resource$Organizations$Locations;
    ...
    backupdr_v1.Resource$Organizations$Locations$Resourcebackupconfigs = Resource$Organizations$Locations$Resourcebackupconfigs;
    ...
    class Resource$Projects$Locations$Backupvaults$Datasources$Backups {
        ...
        fetchForResourceType(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/backups:fetchForResourceType').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    class Resource$Projects$Locations$Datasourcereferences {
        ...
        list(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/dataSourceReferences').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    class Resource$Projects$Locations$Trial {
        ...
        constructor(context) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/trial:end').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,

...
export declare namespace netapp_v1 {
    ...
    export class Resource$Projects$Locations$Storagepools {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        restoreVolume(params: Params$Resource$Projects$Locations$Storagepools$Restorevolume, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        restoreVolume(params?: Params$Resource$Projects$Locations$Storagepools$Restorevolume, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        restoreVolume(params: Params$Resource$Projects$Locations$Storagepools$Restorevolume, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        restoreVolume(params: Params$Resource$Projects$Locations$Storagepools$Restorevolume, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        restoreVolume(params: Params$Resource$Projects$Locations$Storagepools$Restorevolume, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateBackupConfig(params: Params$Resource$Projects$Locations$Storagepools$Updatebackupconfig, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        updateBackupConfig(params?: Params$Resource$Projects$Locations$Storagepools$Updatebackupconfig, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        updateBackupConfig(params: Params$Resource$Projects$Locations$Storagepools$Updatebackupconfig, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        updateBackupConfig(params: Params$Resource$Projects$Locations$Storagepools$Updatebackupconfig, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        updateBackupConfig(params: Params$Resource$Projects$Locations$Storagepools$Updatebackupconfig, callback: BodyResponseCallback<Schema$Operation>): void;
    ...
    export class Resource$Projects$Locations$Storagepools$Backupconfigs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Storagepools$Backupconfigs$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Storagepools$Backupconfigs$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListBackupConfigsResponse>>;
        list(params: Params$Resource$Projects$Locations$Storagepools$Backupconfigs$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Storagepools$Backupconfigs$List, options: MethodOptions | BodyResponseCallback<Schema$ListBackupConfigsResponse>, callback: BodyResponseCallback<Schema$ListBackupConfigsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Storagepools$Backupconfigs$List, callback: BodyResponseCallback<Schema$ListBackupConfigsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListBackupConfigsResponse>): void;
    }

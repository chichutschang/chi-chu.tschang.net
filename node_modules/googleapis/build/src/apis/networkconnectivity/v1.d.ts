...
export declare namespace networkconnectivity_v1 {
    ...
    export class Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleLongrunningOperation>>;
        create(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunningOperation>, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        create(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Create, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        create(callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleLongrunningOperation>>;
        delete(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Delete, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunningOperation>, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        delete(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Delete, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        delete(callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GatewayAdvertisedRoute>>;
        get(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Get, options: MethodOptions | BodyResponseCallback<Schema$GatewayAdvertisedRoute>, callback: BodyResponseCallback<Schema$GatewayAdvertisedRoute>): void;
        get(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Get, callback: BodyResponseCallback<Schema$GatewayAdvertisedRoute>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListGatewayAdvertisedRoutesResponse>>;
        list(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$List, options: MethodOptions | BodyResponseCallback<Schema$ListGatewayAdvertisedRoutesResponse>, callback: BodyResponseCallback<Schema$ListGatewayAdvertisedRoutesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$List, callback: BodyResponseCallback<Schema$ListGatewayAdvertisedRoutesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListGatewayAdvertisedRoutesResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleLongrunningOperation>>;
        patch(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunningOperation>, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        patch(params: Params$Resource$Projects$Locations$Spokes$Gatewayadvertisedroutes$Patch, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
    }

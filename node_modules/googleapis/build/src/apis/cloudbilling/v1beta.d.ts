...
export declare namespace cloudbilling_v1beta {
    ...
    export class Resource$V1beta {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generateInsights(params: Params$Resource$V1beta$Generateinsights, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        generateInsights(params?: Params$Resource$V1beta$Generateinsights, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GenerateInsightsResponse>>;
        generateInsights(params: Params$Resource$V1beta$Generateinsights, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        generateInsights(params: Params$Resource$V1beta$Generateinsights, options: MethodOptions | BodyResponseCallback<Schema$GenerateInsightsResponse>, callback: BodyResponseCallback<Schema$GenerateInsightsResponse>): void;
        generateInsights(params: Params$Resource$V1beta$Generateinsights, callback: BodyResponseCallback<Schema$GenerateInsightsResponse>): void;
        generateInsights(callback: BodyResponseCallback<Schema$GenerateInsightsResponse>): void;
    }

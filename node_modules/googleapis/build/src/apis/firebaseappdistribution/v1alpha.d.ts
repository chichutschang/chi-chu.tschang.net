...
export declare namespace firebaseappdistribution_v1alpha {
    ...
    export class Resource$Projects$Apps$Testcases {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        clearTestCaseCache(params: Params$Resource$Projects$Apps$Testcases$Cleartestcasecache, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        clearTestCaseCache(params?: Params$Resource$Projects$Apps$Testcases$Cleartestcasecache, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleFirebaseAppdistroV1alphaClearTestCaseCacheResponse>>;
        clearTestCaseCache(params: Params$Resource$Projects$Apps$Testcases$Cleartestcasecache, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        clearTestCaseCache(params: Params$Resource$Projects$Apps$Testcases$Cleartestcasecache, options: MethodOptions | BodyResponseCallback<Schema$GoogleFirebaseAppdistroV1alphaClearTestCaseCacheResponse>, callback: BodyResponseCallback<Schema$GoogleFirebaseAppdistroV1alphaClearTestCaseCacheResponse>): void;
        clearTestCaseCache(params: Params$Resource$Projects$Apps$Testcases$Cleartestcasecache, callback: BodyResponseCallback<Schema$GoogleFirebaseAppdistroV1alphaClearTestCaseCacheResponse>): void;
        clearTestCaseCache(callback: BodyResponseCallback<Schema$GoogleFirebaseAppdistroV1alphaClearTestCaseCacheResponse>): void;
        /**

...
(function (oracledatabase_v1) {
    ...
    class Resource$Projects$Locations {
        ...
        constructor(context) {
            ...
            this.odbNetworks = new Resource$Projects$Locations$Odbnetworks(this.context);
    ...
    class Resource$Projects$Locations$Odbnetworks {
        context;
        odbSubnets;
        constructor(context) {
            this.context = context;
            this.odbSubnets = new Resource$Projects$Locations$Odbnetworks$Odbsubnets(this.context);
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/odbNetworks').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    oracledatabase_v1.Resource$Projects$Locations$Odbnetworks = Resource$Projects$Locations$Odbnetworks;
    class Resource$Projects$Locations$Odbnetworks$Odbsubnets {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/odbSubnets').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    oracledatabase_v1.Resource$Projects$Locations$Odbnetworks$Odbsubnets = Resource$Projects$Locations$Odbnetworks$Odbsubnets;

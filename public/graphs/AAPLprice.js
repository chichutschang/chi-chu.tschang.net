...
var element = typeof module !== 'undefined' && module.exports ? 'body' : '#AAPLprice';
...
var clip = svg1.append("defs").append("clipPath")
        .attr("id", "clip")
      .append("rect")
        .attr("class", "zoom")
...
//append the clip
var focuschartlines = svg1.append("g")
         .attr("class", "focus")
...
var url ="https://cors-anywhere.herokuapp.com/https://docs.google.com/spreadsheets/d/e/2PACX-1vTKS3FYmpBnEZde6YXzmlrpWr3hZlGqykA7FrZE2Hbdo7wn2uJnW-HRBvE7Kzqrn5cNrVLBdP6i5omY/pub?gid=492548184&single=true&output=tsv"
...
const focus = svg1.selectAll("focus")
        .data(multiples)
        .enter()
        .append("g");
...
const context = svg1.selectAll("context")
        .data(multiples)
        .enter()
        .append("g");
...
//-------------------------TOOLTIP-------------------------//
  ...
  const rectangle = svg1.append("rect")
                      .attr("width", (width - margin.right))
                      .attr("height", height)
                      .attr("class", "zoom")
